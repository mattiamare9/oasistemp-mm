![docker image](https://github.com/mattiamare9/oasistemp-mm/actions/workflows/docker-publish.yml/badge.svg)


# mattiamare9's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of mattiamare9.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/mattiamare9/oasistemp-mm.git
    cd oasistemp-mm
    ```
    ...
    ```sh
    curl-L -o oasistemp-mm.zip "https://github.com/mattiamare9/oasistemp-mm/archive/main.zip"
    unzip oasistemp-mm.zip
    cd oasistemp-mm
    ```
...
your `docker-compose.yaml` with `ghcr.io/mattiamare9/oasistemp-mm:main` for the services
...
```sh
docker pull ghcr.io/mattiamare9/oasistemp-mm/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/mattiamare9/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/mattiamare9/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/mattiamare9/oasistemp-mm/manifests/main": unauthorized`
